    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'mask':
          ...
          break;
        case 'alcohol':
          result.alcohol = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'food':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  int _mask;
  int get mask => _$this._mask;
  set mask(int mask) => _$this._mask = mask;

  int _alcohol;
  int get alcohol => _$this._alcohol;
  set alcohol(int alcohol) => _$this._alcohol = alcohol;

  int _food;
  int get food => _$this._food;
  set food(int food) => _$this._food = food;
